...
# belirlenen mesaj id'sinde belirlenen bir emojiye basıldığında belirtilen rol verilir. bkz. satır 69-73-75
@bot.event
...
# belirlenen mesaj id'sinde belirlenen emojiye basılı olduğu halde tekrar basma durumunda belirtilen rol kaldırılır. bkz. satır 88-92-94
@bot.event
